...
In figure 2 we can observe the prevalence and abundance of the OTUs at phylum level. Each point is a different OTU, prevalence in Y axis is the times an OTU is observed at least once, that is, the percentage of samples in which each OTU is present. The x axis is the abundance in which each OTU is found. 
...
### FIGURE 8A: Beta diversity Cecum (Treatment)

```{r , echo=FALSE}
plot.beta.bray.cecum
```

### FIGURE 8B: Beta diversity Ileum (Treatment)
```{r , echo=FALSE}
plot.beta.bray.ileum
```

### FIGURE 8C:Beta diversity Feces (Treatment)
...
### FIGURE 9A: Beta diversity Cecum (Calcium)
...
### FIGURE 9B: Beta diversity Ileum (Calcium)
```{r , echo=FALSE}
...
### FIGURE 9C: Beta diversity Feces (Calcium)
...
Row {data-height=900}
-----------------------------------------------------------------------
### TABLE 3: Metabolic information of groups corresponding to broad taxonomic ranges (Phylum, Class, Order, Family)
...
### FIGURE 13: Histopathology scores agreggated by Treatment - Ileum
...
Row {data-height=100}
-----------------------------------------------------------------------
To plot this data we use -log foldchange transformations relative to the control condition (in this case the control group is treatment "MediumLowCa" as this is the widely recommended level of Calcium for broilers diet). The **higher** the values, the higher the expression of the gene in the treatment compared to the **control** level. Significant differences between groups were tested by ANOVA or multiple t-test (ie
...
### FIGURE 16: Kendall correlation heatmap between microbial families and host genes
...
### FIGURE 17: Cecum taxonomic composition by histopathology score {data-width=400}
...
### FIGURE 18: Ileum taxonomic composition by histopathology score {data-width=400}
...
### FIGURE 19: Gene expression vs. Histopathology in the Cecum
...
Row 
-----------------------------------------------------------------------
### FIGURE 20: Gene expression vs. Histopathology in the Ileum
...
### FIGURE 25B: Histo vs Alpha diversity - Ileum {data-width=500}
