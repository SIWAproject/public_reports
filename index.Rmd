...
species_taxonomy_info <-read.csv(file=paste0(folder, "species_metabolic_effects.csv") ,check.names = FALSE, sep=";", row.names = 1)
genera_taxonomy_info <- read.csv(file=paste0(folder,"genus_metabolic_effects.csv"), check.names = FALSE, sep=";", row.names = 1)
...
Row {data-height=600}
-----------------------------------------------------------------------
### FIGURE 28A: Inflammation severity in the ileum. <br/> Impact of treatment on inflammation severity.
...
### FIGURE 28B: Ileum Inflammation severity scores for individual samples at recomended level of calcium. 
...
Row {data-height=600}
-----------------------------------------------------------------------
### FIGURE 29A: Cecum histopathology traits with and without VitD at recomended level of calcium (individual samples). 
```{r Histo plots by sample subset,fig.width = 10, fig.height = 5, include=TRUE, echo=FALSE}
...
### FIGURE 29B: Cecum histopathology traits with and without VitD at recomended level of calcium. <br/> Letters indicate significantly different groups as calculated by Tukey test. There is a significant effect of treatment on the mean additive score: MedLow+VitD has a lower score, indicating the lowest level of abnormality or damage.

```{r Histo plots by treatment-cec subset,fig.width = 10, fig.height = 8, echo=FALSE}

#ANOVA STATS
#cecum AdditiveScore
res.aov <- aov(AdditiveScore ~ Alphad3_level, data = histoca_cecum)
#summary(res.aov) #Additive score changes significantly with treatment in cecum. pval=8.86e-13 ***
tukey <- TukeyHSD(res.aov)
#print(tukey)
#letters to add statistics to graph 
cld <- multcompLetters4(res.aov, tukey)
