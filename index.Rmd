...
### FIGURE 1:Prevalence of OTUs in samples: Regardless of treatment or group, a small number of OTUs dominate the community, and most OTUs are only present in a small number of samples. {data-width=700}
...
### FIGURE 2: Prevalence of Major Phyla: Firmicutes have a larger share of the overall community than any other phylum.  The most abundant OTUs (x axis) also tend to be the most prevalent (y axis). {data-width=800}
...
Row {data-height=500}
-----------------------------------------------------------------------
### FIGURE 4A: Taxonomic composition Cecum: The experimental groups are overall quite similar in their microbial composition, with some differences in abundance of Lactobacillus and Subdoligranulum to name just two.{data-width=1000}
...
Row {data-height=500}
-----------------------------------------------------------------------
### FIGURE 4B: Taxonomic composition Ileum: Lactobacillus is the dominant microbe in the ileum, and varies between 60-80% depending on the group. {data-width=1000}
```{r, echo=FALSE, include=TRUE}
...
Row {data-height=500}
-----------------------------------------------------------------------
### FIGURE 4C: Taxonomic composition Feces: The feces look very similar to the ileum, but with more variability.
 {data-width=1000}
```{r, echo=FALSE, include=TRUE}
...
### FIGURE 5: Alpha diversity grouped by sample location: Cecum(C), Ileum(I), Feces(F). The cecum has higher richness and diversity than the ileum and feces, and the feces have outlier samples that look more like the cecum. {data-width=650}
...
Row {data-height=400}
-----------------------------------------------------------------------
### FIGURE 6A: Cecum diversity: There is variability in group-specific diversity within the cecum, but no clear pattern based on treatment.
...
### FIGURE 6B: Ileum diversity: The MediumHigh + VitD group had higher richness than some other groups, but no clear pattern is indicated. Richness may increase with increasing Ca levels, but only to the MediumHigh level before falling in the High Ca group.
...
### FIGURE 6C: Feces diversity: No clear pattern in richness or diversity between groups is indicated in the feces.
...
### FIGURE 7: Dissimilarity between all samples (Bray distances): The cecum is distinct from the ileum and feces, while ileal and fecal samples are more variable, and more overlapping. {data-width=650}
```{r , echo=FALSE}
plot.beta.bray
```
...
### FIGURE 8A: Beta diversity Cecum (Treatment): The experimental groups do not cluster clearly when all treatment levels are included.

```{r , echo=FALSE}
plot.beta.bray.cecum
```

### FIGURE 8B: Beta diversity Ileum (Treatment): The experimental groups do not cluster clearly when all treatment levels are included.
```{r , echo=FALSE}
plot.beta.bray.ileum
```

### FIGURE 8C:Beta diversity Feces (Treatment): The experimental groups do not cluster clearly when all treatment levels are included.
...
### FIGURE 9A: Beta diversity Cecum (Calcium): The low calcium samples (1) and high calcium samples (4) separate cleanly, while the intermediate groups overlap them.
...
### FIGURE 9B: Beta diversity Ileum (Calcium): There is no clear impact of calcium level on beta diversity in the ileum.
```{r , echo=FALSE}
...
### FIGURE 9C: Beta diversity Feces (Calcium): There is no clear impact of calcium level on beta diversity in the feces.
...
### FIGURE 11A: Cecum diff - VitD level: Lactobacillus coleohominis is increased with VitD supplementation, while several others are decreased.  {data-width=500}
...
### FIGURE 11B: Feces diff - VitD level: Several bacterial groups were decreased with VitD supplementation.  {data-width=500}
```{r , echo=FALSE}
comparison= 7
...
### FIGURE 12: Histopathology scores aggregated by Treatment - Cecum:  Letters indicate significantly different groups as calculated by Tukey test. There is a significant effect of treatment on the mean additive score: MedLow+VitD has the lowest score, indicating the lowest level of abnormality or damage.
...
### FIGURE 13: Histopathology scores aggregated by Treatment - Ileum: Letters indicate significantly different groups as calculated by Tukey test. There is no significant impact of treatment on ileal histo scores.  However, it is of note that the general level of aberration in the ileum is much lower than in the cecum, regardless of treatment.
...
Row {data-height=100}
-----------------------------------------------------------------------
To plot this data we use negative logarithmic fold change transformations relative to the control condition (in this case the control group is treatment "MediumLowCa" as this is the widely recommended level of Calcium for broilers diet). The **higher** the values, the higher the expression of the gene in the treatment compared to the **control** level. Significant differences between groups (indicated by letters in the figure) were tested by ANOVA or multiple t-test (ie
...
### FIGURE 14A: Cecum - IL1B: No impact of treatment on expression levels in the cecum.
```{r , echo=FALSE}
...
### FIGURE 14B: Cecum - IL10: Addition of VitD to the MediumLow Ca group appears to reduce expression of IL10 compared to the control as well as several other groups.
```{r fig14b, echo=FALSE}
...
### FIGURE 14C: Cecum - MUC2: No impact of treatment on expression levels in the cecum.
```{r 14c, echo=FALSE}
...
Row {data-height=500}
-----------------------------------------------------------------------
### FIGURE 15A: Ileum - IL1B: Higher levels of calcium in the diet appear to lead to higher levels of IL1B expression in the ileum.
...
### FIGURE 15B: Ileum - IL10: There may be a VitD-dependent difference in the expression of IL10 in the ileum.
...
### FIGURE 15C: Ileum - MUC2: Expression of MUC2 in the ileum was not affected by treatment.
...
### FIGURE 16: Kendall correlation heatmap between microbial families and host genes: Families such as Sutterellaceae, Erysipelotcrichaceae, Eggerthellaceae, and Anaerovoracaceae are strongly associated with higher Il10 expression in the ileum.  
...
### FIGURE 17: Cecum taxonomic composition by histopathology score: The genus-level composition of the microbiome differs when samples are grouped by histopathology scores, but the imbalance of the data limits our ability to make conclusions from this analysis. {data-width=400}
...
### FIGURE 18: Ileum taxonomic composition by histopathology score: The genus-level composition of the microbiome differs when samples are grouped by histopathology scores, but the imbalance of the data limits our ability to make conclusions from this analysis. {data-width=400}
...
### FIGURE 19: Gene expression vs. Histopathology in the Cecum: This plot does not show any clear relationship between gene expression and histopathology scores, but the imbalance of the histopathology data may be partly responsible for that.
...
Row 
-----------------------------------------------------------------------
### FIGURE 20: Gene expression vs. Histopathology in the Ileum: This plot does not show any clear relationship between gene expression and histopathology scores, but the imbalance of the histopathology data may be partly responsible for that.
...
Row 
-----------------------------------------------------------------------
### FIGURE 21: Alpha diversity vs. Gene expression - Cecum: There are no statistically significant relationships between gene expression and alpha diversity, however, IL1B shows a tendency to increase with increasing alpha diversity scores. {data-width=500}
...
Row 
-----------------------------------------------------------------------
### FIGURE 22: Alpha diversity vs. Gene expression - Ileum: There are no statistically significant relationships between gene expression and alpha diversity in the ileum. {data-width=500}
...
Row 
-----------------------------------------------------------------------
### FIGURE 23: Ratios vs. Gene Expression - Cecum: There are no statistically significant relationships between gene expression and SIWA ratios in the cecum.   {data-width=500}
...
Row
-----------------------------------------------------------------------
### FIGURE 24: Ratios vs. Gene Expression - Ileum: There are no statistically significant relationships between gene expression and SIWA ratios in the ileum, however there may be a tendency for IL1B and MUC2 expression to decrease with increasing levels of Lactobacillus (Ratio 3). {data-width=500}
...
### FIGURE 25A: Histo vs Alpha diversity - Cecum: There is no significant relationship between histopathology scores and alpha diversity in the cecum. {data-width=500}
...
### FIGURE 25B: Histo vs Alpha diversity - Ileum: There is no significant relationship between histopathology scores and alpha diversity in the ileum. {data-width=500}
...
### FIGURE 26A: Histo vs Ratios - Cecum: There is no significant relationship between histopathology scores and SIWA ratios in the cecum. {data-width=500}
...
### FIGURE 26B: Histo vs Ratios - Ileum: There is no significant relationship between histopathology scores and SIWA ratios in the ileum. {data-width=500}
