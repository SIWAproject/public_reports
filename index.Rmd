...
#table_sample_count_cecum <- rbindlist(lapply(freq_c, function(x) as.data.frame.list(x)), fill=TRUE)
#table_sample_count_cecum <- as.data.frame(table_sample_count_cecum)
#rownames(table_sample_count_cecum) <- str_replace(names(freq_c), "LEVEL", "")
...
# subset.genus.df_cecum <- subset.genus.df_cecum  %>% dplyr::select(OTU,Abundance,
...
#   MicrobialOrganismsLEVEL
# )
#Melted[Melted$OTU == "Subdoligranulum",]
```
